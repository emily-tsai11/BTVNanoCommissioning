...
python runner.py --json metadata/"$arg1"/MC_"$arg1"_"$arg2"_BTV_Run3_"$arg2"_Comm_MINIAODv4_NanoV12.json --workflow ttsemilep_sf --campaign $arg1 --year $arg2 --executor $arg3 --retries 1 -s 5 --limit 1 --max 1 --noHist --isArray --overwrite
python runner.py --json metadata/"$arg1"/data_"$arg1"_"$arg2"_mu_BTV_Run3_"$arg2"_Comm_MINIAODv4_NanoV12.json --workflow ttsemilep_sf --campaign $arg1 --year $arg2 --executor $arg3 --retries 1 -s 5 --limit 1 --max 1  --noHist --isArray --overwrite
